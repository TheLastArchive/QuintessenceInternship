...
namespace DamData
{
    class DataStorer
    {
        ...
        public Dictionary<string, Dam> damObjectsDict { set;  get; }
        ...
        private void CreateDictionaryOfDamObjects()
        {
            damObjectsDict = new Dictionary<string, Dam>();
            for (int i = 0; i < damNames.Length; i++)
                damObjectsDict.Add(damNames[i].ToUpper(), damObjects[i]);
        }
